...
`connect-src` allowlist or every socket dies at connect time. See [WebSocket](/api/websocket).
...
- [WebSocket](/api/websocket) — the four channels above, with payload shapes.
